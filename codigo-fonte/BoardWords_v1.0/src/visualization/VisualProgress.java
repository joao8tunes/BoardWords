...
public class VisualProgress
{
    ...
    private TextViewer t;    //Classe onde o processo está ocorrendo; necessário para informar seu cancelamento.
    
    
    public VisualProgress(final TextViewer t, final boolean clear)
	{
    	this.t = t;
